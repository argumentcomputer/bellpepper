...
impl<Scalar: PrimeField> TestShapeCS<Scalar> {
    #[allow(unused)]
...
impl<Scalar: PrimeField> Default for TestShapeCS<Scalar> {
    fn default() -> Self {
...
impl<Scalar: PrimeField> ConstraintSystem<Scalar> for TestShapeCS<Scalar> {
    type Root = Self;
